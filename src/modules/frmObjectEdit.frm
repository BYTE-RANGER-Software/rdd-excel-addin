...
Public Property Let Field2Visible(value As Boolean)
    ...
    If value = True And Not Me.m_txt1.Visible Then
        Field1Visible = True
...
Public Property Let Field3Visible(value As Boolean)
    ...
    If value = True And Not Me.m_txt1.Visible Then
        Field1Visible = True
    End If
    If value = True And Not Me.m_txt2.Visible Then
        Field2Visible = True
    End If
...
Public Property Let Field4Visible(value As Boolean)
    ...
    If value = True And Not Me.m_txt2.Visible Then
        Field2Visible = True
    End If
    If value = True And Not Me.m_txt3.Visible Then
        Field3Visible = True
    End If
...
Public Property Let Field5Visible(value As Boolean)
    ...
    If value = True And Not Me.m_txt3.Visible Then
        Field3Visible = True
    End If
    If value = True And Not Me.m_txt4.Visible Then
        Field4Visible = True
    End If
...
Public Property Let Field6Visible(value As Boolean)
    ...
    If value = True And Not Me.m_txt4.Visible Then
        Field4Visible = True
    End If
    If value = True And Not Me.m_txt5.Visible Then
        Field5Visible = True
    End If
...
Public Property Let Text1Prefix(ByVal value As String)
    m_txt1Prefix = value
    If Len(value) > 0 And Not m_txt1.text Like value & "*" Then
        m_txt1.text = value
    End If
End Property
...
Public Property Let Text2Prefix(ByVal value As String)
    m_txt2Prefix = value
    If Len(value) > 0 And Not m_txt2.text Like value & "*" Then
        m_txt2.text = value
    End If
End Property
...
Public Property Let Text3Prefix(ByVal value As String)
    m_txt3Prefix = value
    If Len(value) > 0 And Not m_txt3.text Like value & "*" Then
        m_txt3.text = value
    End If
End Property
...
Public Property Let Text4Prefix(ByVal value As String)
    m_txt4Prefix = value
    If Len(value) > 0 And Not m_txt4.text Like value & "*" Then
        m_txt4.text = value
    End If
End Property
...
Public Property Let Text5Prefix(ByVal value As String)
    m_txt5Prefix = value
    If Len(value) > 0 And Not m_txt5.text Like value & "*" Then
        m_txt5.text = value
    End If
End Property
...
Public Property Let Text6Prefix(ByVal value As String)
    m_txt6Prefix = value
    If Len(value) > 0 And Not m_txt6.text Like value & "*" Then
        m_txt6.text = value
    End If
End Property
...
Private Sub m_txt1_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
    If m_txt1NumericOnly Then KeyAscii = ValidateNumericInput(KeyAscii)
End Sub

Private Sub m_txt2_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
    If m_txt2NumericOnly Then KeyAscii = ValidateNumericInput(KeyAscii)
End Sub

Private Sub m_txt3_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
    If m_txt3NumericOnly Then KeyAscii = ValidateNumericInput(KeyAscii)
End Sub

Private Sub m_txt4_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
    If m_txt4NumericOnly Then KeyAscii = ValidateNumericInput(KeyAscii)
End Sub

Private Sub m_txt5_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
    If m_txt5NumericOnly Then KeyAscii = ValidateNumericInput(KeyAscii)
End Sub

Private Sub m_txt6_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
    If m_txt6NumericOnly Then KeyAscii = ValidateNumericInput(KeyAscii)
End Sub

Private Sub m_txt1_Change()
    EnforcePrefixForTextBox m_txt1, m_txt1Prefix
    Call UpdateOKButton
End Sub

Private Sub m_txt2_Change()
    EnforcePrefixForTextBox m_txt2, m_txt2Prefix
    Call UpdateOKButton
End Sub

Private Sub m_txt3_Change()
    EnforcePrefixForTextBox m_txt3, m_txt3Prefix
    Call UpdateOKButton
End Sub

Private Sub m_txt4_Change()
    EnforcePrefixForTextBox m_txt4, m_txt4Prefix
    Call UpdateOKButton
End Sub

Private Sub m_txt5_Change()
    EnforcePrefixForTextBox m_txt5, m_txt5Prefix
    Call UpdateOKButton
End Sub

Private Sub m_txt6_Change()
    EnforcePrefixForTextBox m_txt6, m_txt6Prefix
    Call UpdateOKButton
End Sub
